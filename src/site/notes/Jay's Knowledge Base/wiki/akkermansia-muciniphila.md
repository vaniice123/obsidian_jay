...
- [[Jay's Knowledge Base/raw/555-li-2026-akkermansia-muciniphiladerived-l-norleucine-modulates\|raw/555-li-2026-akkermansia-muciniphiladerived-l-norleucine-modulates]] — *A. muciniphila* 유래 **L-노르류신**이 장상피 FABP1의 경쟁적 억제제로 식이 지방산 흡수를 차단, 풍부도가 FABP1 의존적 비만과 역상관·보충 시 비만 완화 → 장내 미생물–FABP1 축 (*PNAS* 2026)
- [[Jay's Knowledge Base/raw/567-rao-unknown-amuc1473-links-gut-microbes-to-skeletal-homeostasis\|raw/567-rao-unknown-amuc1473-links-gut-microbes-to-skeletal-homeostasis]] — EV 농축 분비 단백질 **Amuc_1473**이 NELF-E·RPL26 결합으로 골형성 촉진·파골세포 형성 억제, 다요인성 골다공증서 Akk·EV와 함께 감소·간헐적 단식으로 회복 → gut–bone axis effector (*Advanced Science* 2026)
...
- [[Jay's Knowledge Base/raw/582-li-2026-strain-dependent-efficacy-of-pasteurized-akkermansia\|raw/582-li-2026-strain-dependent-efficacy-of-pasteurized-akkermansia]] — 살균 *A. muciniphila* **39개 균주** 스크리닝(in vitro HT-29 염증 모델 → DSS 유도 UC 마우스), 균주 간 효능 편차 상당. 최우수 **AKK2645**는 대장 Th17/Treg·Th1/Th2 비율 조절로 il-6·il-1β·tnf-α·il-17a·ifn-γ·il-23↓, il-10·foxp3·gata3↑, 16S에서 *Dubosiella*·*Bifidobacterium*·*Limosilactobacillus*↑ / *Ileibacterium*·*Alistipes*↓ → **살균 처리 효과는 균주 특이적(strain-specific)** (*Front. Nutr.* 2026)
- [[Jay's Knowledge Base/raw/583-sharma-2026-interactions-between-akkermansia-species-and\|raw/583-sharma-2026-interactions-between-akkermansia-species-and]] — **학위논문(dissertation, Duke University 2026)** — *Akkermansia* 속과 위장관 뮤신의 상호작용. 다중오믹스로 다양한 *Akkermansia* 종의 기능적 역량 및 *A. muciniphila*가 타 종 대비 우점하는 기전 규명, **PEPCTERM 뮤신 결합 단백질**이 in vivo 정착에 필수(세포외 다당 매개 추정), 세포내 뮤신 축적 관련 유전자 동정용 FACS 프로토콜 확립 → *A. muciniphila* 외 종으로의 *Akkermansia* 프로바이오틱 플랫폼 확장 시사. ※ 동료심사 저널 논문이 아닌 학위논문으로 **근거 수준(evidence level) 해석에 유의**
- [[Jay's Knowledge Base/raw/584-wei-2026-functional-and-structural-characterization-of\|raw/584-wei-2026-functional-and-structural-characterization-of]] — *A. muciniphila* thioredoxin 도메인 함유 단백질 **Amuc_2173**의 thiol-disulfide oxidoreductase 활성 규명, 활성에 coiled-coil CTD 불필요, thioredoxin 도메인 구조는 **ResA/DsbE 아과 thioredoxin fold**, CXXC 모티프 시스테인 잔기가 활성에 필수 → 항산화 잠재력의 실험적 근거 (*Biochem. Biophys. Res. Commun.* 2026)
- [[Jay's Knowledge Base/raw/593-li-2026-peptide-lklkll-is-a-more-effective-component-of\|raw/593-li-2026-peptide-lklkll-is-a-more-effective-component-of]] — *A. muciniphila* 대사 상등액이 STC-1 세포의 GLP-1·GIP 분비 촉진 → 메타볼로믹스 저분자 54종 중 생리활성 **hexapeptide LKLKLL** 동정. HFD 비만 마우스 체중↓·당뇨 모델 내당능↑, **GLP-1↑/GIP↓ 이중 조절**, **GPR119–Gαs/adenylate cyclase/cAMP–세포내 Ca²⁺** 경로 제시. ※ 수용체 귀속은 저자도 "may interact" 수준으로 결합 친화도·수용체 결손 검증 미완 (*Gut Microbes* 2026)

---
{"dg-publish":true,"permalink":"/jay-s-knowledge-base/wiki/obesity-body-composition/","dg-note-properties":{}}
---

# 비만, 체성분, 대사

비만은 장내 미생물 군집의 구조적 변화와 밀접하게 연관된 대사 질환으로, 장내 미생물의 다양성 및 풍부도 감소가 비만 환자에서 일관되게 관찰된다. Hu et al. (2024)의 메타분석(1,351개 대변 메타게놈)에 따르면, 비만 환자에서 장내 세균총(bacteriome) 및 바이롬(virome) 모두의 풍부도와 다양성이 유의하게 감소하며, 38개 세균 종이 비만 바이오마커로 확인되었다.

장내 미생물과 비만의 관계는 에너지 항상성, 기초대사율(resting metabolic rate), 지질 대사, 면역 조절 등 다층적 경로를 통해 매개된다. 과체중/비만 여성에서 *Firmicutes*, *Bacteroidetes*, *Akkermansia muciniphila*, *Faecalibacterium prausnitzii* 등 비만 조절 핵심 미생물의 상대 풍부도가 정상 대사(normometabolic) 군과 저대사(hypometabolic) 군 간에 유의한 차이를 보이며, 이는 장내 미생물이 기초대사율에 직접적 영향을 미칠 수 있음을 시사한다 (Mehranfar et al., 2023).

단쇄지방산(SCFAs)은 장내 미생물-비만 축의 핵심 매개체로, 장 장벽 보호, G 단백질 결합 수용체(GPCRs) 활성화, 후성유전적(epigenetic) 조절을 통해 만성 저등급 염증(chronic low-grade inflammation)을 억제하고 대사 항상성을 유지한다. LPS 유래 대사 내독소혈증(metabolic endotoxemia)의 억제가 비만 예방의 주요 기전 중 하나이다 (Kopczynska & Kowalczyk, 2024).
...
### 장내 미생물-비만 연관성
- 비만 환자에서 장내 미생물 풍부도·다양성 감소가 일관되게 관찰 (메타분석, n=1,351)
- 38개 세균 종이 비만 관련 바이오마커로 확인, *Oscillibacter*, *Prevotella copri* 등 특정 종의 증감 패턴
- *Bacteroides*, *Faecalibacterium*, *Akkermansia* 등 유익균의 감소가 비만과 연관 (Hu et al., 2024)

### 기초대사율(RMR)과 장내 미생물
- 과체중/비만 여성에서 정상 대사 군과 저대사 군 간 장내 미생물 조성 차이 확인
- *Firmicutes*, *Bacteroidetes*, *A. muciniphila*, *F. prausnitzii*, *E. coli* 등의 상대 풍부도가 대사율과 연관
- 장내 미생물 조절을 통한 에너지 소비 증진 가능성 시사 (Mehranfar et al., 2023)

### 당뇨 약물과 장내 미생물
- Metformin이 장내 미생물 조성을 변화시켜 혈당 조절 이상의 대사 효과 발휘
- *Akkermansia*, *Lactobacillus* 등 유익균 풍부도 증가와 연관
- 장내 미생물 매개 효과가 당뇨 약물의 숨은 작용 기전일 가능성 (Chaithanya et al., 2024)

### SCFAs의 후성유전적 조절과 비만
- 부티르산, 아세트산, 프로피온산 등 SCFAs가 HDAC 억제를 통해 후성유전적 조절 수행
- GPCRs(GPR41, GPR43) 활성화를 통한 면역·대사 신호 전달
- LPS 유래 대사 내독소혈증 억제를 통한 만성 저등급 염증 완화
- 2형 당뇨(T2D), 심혈관 질환(CVD), 암 예방에 기여 (Kopczynska & Kowalczyk, 2024)

### 식이 중재 — 간헐적 단식 vs 지속적 에너지 제한
- 연속적(continuous) vs 간헐적(intermittent) 에너지 제한의 체성분 변화 비교 연구
- 장기적 체중 감량 유지 및 체성분(fat mass, lean mass) 변화에 대한 식이 전략 비교 (Arguin; Willoughby, 2018)

### Semaglutide와 장내 미생물/체성분
...
### GLP-1 RA 감량의 섭취량 기여 정량화 — ad libitum 점심 −1132 kJ (Quan 2026)

**「GLP-1 RA 감량의 얼마만큼이 실제 섭취량 감소로 설명되는가」를 객관적 측정치로 풀링한 첫 메타분석.** Quan et al. (2026, *Diabetes & Metabolic Syndrome*, [[Jay's Knowledge Base/raw/604-quan-2026-nutritional-intake-changes-during-glp-1-receptor\|raw/604-quan-2026-nutritional-intake-changes-during-glp-1-receptor]])은 6개 데이터베이스를 2026-03-31까지 검색해 GLP-1 또는 이중 GIP/GLP-1 수용체 작용제 투여 성인의 정량적 식이 결과를 체계적 문헌고찰(16편)로 정리하고, **≥4주 무작위·교차 위약대조 시험 중 표준화 ad libitum 점심 섭취량(standardized ad libitum lunch intake)** 을 보고한 연구를 DerSimonian-Laird 랜덤효과 모형으로 풀링했다(3개 시험 4개 arm, 209명; 사전 명시 민감도 분석 — REML·Paule-Mandel 추정량, 95% 예측구간, 하위군, leave-one-out).

- **풀링 치료 차이**: **−1132 kJ** (95% CI −1449 ~ −815), 약 **−271 kcal**
- **이질성 없음**: I²=0%, 95% 예측구간 −1828 ~ −436 kJ — 향후 유사 환경에서도 효과 방향이 뒤집힐 가능성이 낮음
- 3주 phase 1 tirzepatide 시험 추가 시(k=5) 효과 **−1421 kJ**로 확대되나 **I²=70%**의 상당한 이질성 발생
- **semaglutide vs tirzepatide 차이 유의하지 않음** (p=0.154)

**시사점**: (1) 위 [[Jay's Knowledge Base/wiki/obesity-body-composition#GLP-1/이중 작용제의 DXA 체성분 효과 — 정량 메타분석 (Alaycı 2026)\|Alaycı 2026]]이 incretin 감량의 **결과(체성분)** 를 kg 단위로 정량화했다면, 본 연구는 그 **원인(에너지 섭취)** 측을 kJ 단위로 정량화해 감량 기전 사슬의 상류를 채운다 — 즉 GLP-1 RA 감량은 에너지 소비 증가보다 **측정 가능한 급성 섭취 억제**로 상당 부분 설명된다. (2) **semaglutide와 tirzepatide 간 급성 섭취 억제 크기에 유의차가 없다(p=0.154)** 는 결과는, tirzepatide의 우월한 체중 감량이 단순한 「식욕 억제 강도」 차이만으로는 설명되지 않으며 GIPR 신호를 경유한 별도 경로(에너지 소비·기질 이용·수용체 desensitization 비대칭)를 시사한다 — 아래 [[Jay's Knowledge Base/wiki/obesity-body-composition#GLP-1/GIP 이중 표적 약물의 진화 (Davies 2026)\|이중 표적 패러독스]]와 맞물리는 지점. (3) **한계**: 209명의 소표본이며, 측정 대상이 **표준화 식사 시험에서의 급성 섭취**이지 습관적 일상 섭취(habitual intake)가 아니다 — 저자들도 실세계 습관 섭취가 여전히 보고 부족임을 명시하며, 약물치료를 **충분한 단백질을 강조하는 구조화된 영양 상담**으로 보완할 것을 권고한다. 제지방량 손실의 영양학적 상류 경로라는 관점의 상세는 [[Jay's Knowledge Base/wiki/glp1-muscle-loss#식욕 억제의 정량화 — 표준화 ad libitum 점심 섭취 −271 kcal (Quan 2026)\|glp1-muscle-loss]] 참조.
...
- **해석상 주의**: 같은 논문에서 lean mass는 병용군에서 GLP-1RA 단독 대비 **추가 감소**(p<0.01). 그러나 체성분 측정 장비(Bruker Minispec LF50, TD-NMR)는 골격근과 장기(특히 간)를 분리하지 못하며, 같은 군에서 간 무게가 유의하게 감소(p<0.001) → **lean mass 변화가 골격근 손실인지 간지방 해소인지 현 데이터로 구별 불가**. "Synergy" 통계 검증(2-factor ANOVA interaction)도 미사용
- 시사점: [[Jay's Knowledge Base/wiki/akkermansia-muciniphila\|akkermansia-muciniphila]]의 GLP-1 companion 포지셔닝에서 **대사·간 개선 축은 본 논문이 지지**하나, **근손실 보존 축은 본 데이터로 도출 불가** — DEXA/임상 MRI·grip strength·근육 단면적 직접 측정이 가능한 후속 연구 또는 별도 근거([[Jay's Knowledge Base/wiki/glp1-muscle-loss\|glp1-muscle-loss]] follistatin·SCFA 경로)가 필요

### 살균 *A. muciniphila* — 체중 감량 후 유지 RCT (Mount 2026, *Nature Medicine*)

과체중·비만 성인 90명 대상 이중맹검 RCT ([[Jay's Knowledge Base/raw/518-mount-2026-pasteurized-akkermansia-muciniphila-muct-for-weight\|Mount et al., 2026]]): 8주 저열량식으로 ≥8% 감량 후, 24주 건강 자율식(ad libitum) 기간 동안 살균 *A. muciniphila* MucT 또는 위약을 매일 보충. 1차 평가변수는 유지기 체중 변화.

- **체중 재증가(weight regain) 억제**: MucT 1.2 ± 0.7 kg vs 위약 3.2 ± 0.4 kg (P=0.012)
- **순 체중 감량(baseline → 유지기 종료)**: MucT군이 위약 대비 3.1 ± 0.7 kg 더 큼 (P=0.009)
...
표준 균주 MucT(ATCC BAA-835) 외에 영아 분변 분리주 **Akk11**의 HFD-유도 비만 마우스 모델 연구 ([[Jay's Knowledge Base/raw/509-feng-2025-investigating-the-role-of-akkermansia-muciniphila\|Feng 2025]]):

- **생균·살균형 모두**: Lee's index 감소, 백색지방 면적 축소, 결장 goblet cell 증가, tight junction 단백질 발현 강화
- **살균형**: 16S rRNA 분석에서 *Akkermansia* 속 풍부도 유의 증가, **부티르산** 수치 상승
- **생균형**: **프로피온산** 수치 상승
- 두 형태 모두 isobutyric acid·valeric acid 증가
...
**다만 「Akk → GDF15 → 근손실」 직결은 성립하지 않는다**: ① Zhuang 2026의 GDF15는 **일과성 상승**이고 Gu 2026은 **수년간 만성 고농도**로 시간 척도가 다르며, ② Gu 2026은 **관찰 연구**여서 GDF15가 원인이 아니라 미토콘드리아 스트레스의 **하류 표지**일 수 있고, ③ 중등도 상승은 보호적일 수 있으며(hormesis — **저용량 자극·고용량 억제의 이상성(biphasic) 용량-반응은 생물학적 모델·종결점·화학물질 계열과 무관하게 고도로 일반화되는 현상**이라는 독성학적 정리: [[Jay's Knowledge Base/raw/325-calabrese-2008-neuroscience-and-hormesis-overview-and-general-fin\|raw/325-calabrese-2008-neuroscience-and-hormesis-overview-and-general-fin]], Calabrese 2008, *Critical Reviews in Toxicology* 38(4):249–252; 의학·임상약리학 일반으로의 확장은 [[Jay's Knowledge Base/raw/308-calabrese-2008-hormesis-and-medicine\|raw/308-calabrese-2008-hormesis-and-medicine]], Calabrese 2008, *British Journal of Clinical Pharmacology*, 서지 정보만 확보(초록 미확보). 단 이는 *A. muciniphila*·GDF15 특이적 근거가 아니라 **일반 용량-반응 원리** 수준으로, 「급성 일과성 상승 ≠ 만성 고농도 노출」에 그럴듯한 기전적 근거를 줄 뿐 본 축의 직접 증거는 아니다), ④ 결정적으로 ***A. muciniphila*를 직접 투여한 실험은 근육이 늘었다**(Shin 2021 자연 노화 36주·Park 2025 SAMP8 — 악력·근량·근섬유 CSA↑). 나아가 본 경로는 [[Jay's Knowledge Base/wiki/glp1-muscle-loss#감량 기전에 따른 근손실 위험의 분화 — 식욕억제형 vs 대사형\|식욕억제형 감량]]에 속하므로, **제형에 따라 이 스위치가 켜지는지 여부가 갈릴 수 있다**는 [[Jay's Knowledge Base/wiki/akkermansia-clinical-evidence#생균 vs 살균 — 기능 선택적 분리 가설\|생균 vs 살균 기능 선택적 분리 가설]]이 제기된다(미검증). 논쟁의 전체 정리는 [[Jay's Knowledge Base/wiki/sarcopenia\|sarcopenia]] 참조.
...
- [[Jay's Knowledge Base/raw/48-chaithanya-2024-metabolic-consequences-of-alterations-in-gut\|raw/48-chaithanya-2024-metabolic-consequences-of-alterations-in-gut]]
- [[Jay's Knowledge Base/raw/61-arguin-2012-short-and-long-term-effects-of-continuous-versus\|raw/61-arguin-2012-short-and-long-term-effects-of-continuous-versus]]
- [[Jay's Knowledge Base/raw/62-arguin-interventions-nutritionnelles-pour-la-prevention-et-l\|raw/62-arguin-interventions-nutritionnelles-pour-la-prevention-et-l]]
...
- [[Jay's Knowledge Base/raw/65-mehranfar-2023-the-association-between-gut-microbiota-and-re\|raw/65-mehranfar-2023-the-association-between-gut-microbiota-and-re]]
- [[Jay's Knowledge Base/raw/87-hu-2024-integrative-metagenomic-analysis-reveals-distinct-gu\|raw/87-hu-2024-integrative-metagenomic-analysis-reveals-distinct-gu]]
...
- [[Jay's Knowledge Base/raw/507-lee-2026-critical-reading-of-akk-glp1-paper\|raw/507-lee-2026-critical-reading-of-akk-glp1-paper]] — Gao 2026 비판적 재검토 (체성분 도구·lean mass 해석·4군 설계·통계·검체 정체 등 방법론 이슈)
...
- [[Jay's Knowledge Base/raw/604-quan-2026-nutritional-intake-changes-during-glp-1-receptor\|raw/604-quan-2026-nutritional-intake-changes-during-glp-1-receptor]] — GLP-1/이중 GIP-GLP-1 작용제 투여 시 객관적 식이 섭취 변화 체계적 문헌고찰(16편)·메타분석(3개 시험 4 arm, 209명): 표준화 ad libitum 점심 에너지 섭취 **−1132 kJ(≈−271 kcal, 95% CI −1449~−815, I²=0%, 예측구간 −1828~−436)**, phase 1 tirzepatide 추가 시 −1421 kJ·I²=70%, **semaglutide vs tirzepatide 차이 무의미(p=0.154)**, 습관적 실세계 섭취는 여전히 미보고 → 단백질 강조 영양 상담 권고 (*Diabetes & Metabolic Syndrome* 2026)

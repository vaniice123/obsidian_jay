...
#### AmEV — UC 동반 인지장애의 트립토판 대사 재프로그래밍 (Chen 2026)

***A. muciniphila* 유래 EV(AmEV)**가 장-뇌 축의 분자 매개체로 작동함이 IBD-인지 동반증상 맥락에서 정밀하게 규명되었다 (Chen et al., 2026, *Gut Microbes*, [[Jay's Knowledge Base/raw/536-chen-2026-akkermansia-muciniphila-derived-extracellular-vesicles\|raw/536-chen-2026-akkermansia-muciniphila-derived-extracellular-vesicles]]). DSS-UC 마우스에 AmEV를 투여하면:

1. **장 점막+혈뇌장벽(BBB) tight junction 동시 회복** → MEV가 두 장벽을 가로지르는 분자적 근거
2. **해마 신경염증·미세아교세포·성상교세포 활성 억제**, 전염증 사이토카인 감소
3. **장내 미생물 리모델링** — *Bifidobacterium* 증가·병원성 *Bacteroides·Mucispirillum* 감소·**SCFA 생산 회복**
...
- **사회불안장애**: IL-17A 변화, 옥시토신 발현 감소
- **조현병**: 염증 경로와 연관된 미생물 변화
...
- Lactobacillus, Bifidobacterium → 기분 개선, 불안 감소
- L. rhamnosus (JB-1): 스트레스 유발 불안 행동 감소
- 균주 특이적 효과 → 신중한 선택 필요

### 프리바이오틱스
- FOS, GOS → 스트레스 반응 감소
- GOS 보충 → 건강 자원자의 코르티솔 각성 반응 저하
...
## 미생물 → 뇌간 식욕 회로 — GDF15–GFRAL 축 (Zhuang 2026)
...
운동이 이 축을 매개하는 기전:
1. 장내 미생물 조성·다양성 동적 조절
2. 마이오카인과 장내 미생물 간 상호작용
3. 마이오카인의 신경보호 작용

...
EFSA의 QPS(Qualified Presumption of Safety) 시스템은 식품 및 사료에 의도적으로 첨가되는 미생물의 안전성을 평가하는 제도로, 분류학적 동정(taxonomic identity), 지식 체계(body of knowledge), 안전성 우려(safety concerns), 항균제 내성(antimicrobial resistance)을 평가한다. *A. muciniphila*와 같은 NGP 후보 균주는 아직 QPS 목록에 포함되지 않아, 개별 균주 수준에서의 안전성 입증이 필수적이다. Paquet et al. (2021)은 단일 균주 LBP의 first-in-human 임상진입 시 FDA와 EMA로부터 받은 피드백을 정리하여, 규제기관이 요구하는 비임상/임상 설계와 CMC 데이터 패키지의 실무 가이드를 제공하였다.
...
- **First-in-Human 진입 요건**: 단일 균주 LBP의 임상 1상 진입 시 FDA/EMA가 요구하는 CMC 데이터 패키지, 비임상 안전성 자료, 임상 설계 가이드 정리 (Paquet 2021)
...
- **분류학적 동정의 표준 레퍼런스**: 균주 동정(identification)은 CTD 3.2.S 및 EFSA QPS 평가의 출발점이며, *Bergey's Manual of Systematics of Archaea and Bacteria*는 세균·고세균 분류의 가장 권위 있는 표준 참조 자료로, 매년 ~100개 신규 속·600+ 신규 종이 기재되는 환경에서 LBP/NGP 균주의 속·종 수준 귀속(taxonomic placement)의 근거로 인용 가능 ([[Jay's Knowledge Base/raw/154-unknown-2015-bergeys-manual-of-systematics-of-archaea-and-ba\|Bergey's Manual 2015]])
- **혐기성균/고세균의 AMR 프로파일링 방법론**: QPS·CMC 요구사항인 항균제 감수성 평가는 산소 민감 미생물에서 방법론적 난제를 동반한다. 산소 극도 불내성 장내 고세균 *Methanobrevibacter smithii*는 일반 혐기 배양법으로 검출되지 않아, Hungate 무산소 기법과 3단계 항생제 함유 배지 절차로 분리 후 MIC를 측정한 사례가 보고됨 — 절대혐기성 NGP 후보의 분리·감수성 시험 설계에 참조 가능 ([[Jay's Knowledge Base/raw/214-dermoumi-2001-isolation-and-antimicrobial-susceptibility-tes\|Dermoumi 2001, *Chemotherapy*]])
- **부티르산 생성균의 안전성 caveat — 기회감염**: 분변에서 기재된 절대혐기 그람음성 *Butyricimonas* 속의 *B. virosa*가 결장 선암·대동맥류 수술 환자에서 **첫 균혈증(bacteraemia) 사례**로 보고됨. 대사 개선 효과로 NGP 후보로 검토되는 균주라도 취약 인구에서의 기회감염 가능성은 first-in-human 안전성 평가에서 반드시 고려해야 함을 보여주는 사례 ([[Jay's Knowledge Base/raw/166-ulger-toprak-2015-butyricimonas-virosa-the-first-clinical-ca\|Ulger Toprak 2015, *New Microbes New Infect.*]]; cf. [[Jay's Knowledge Base/wiki/next-generation-probiotics\|next-generation-probiotics]]의 *Butyricimonas* 후보 검토)
- **Enterococcus — AMR/안전성 body of knowledge (참조 균속)**: *Enterococcus faecium*은 QPS 비대상이며 원내 병원체·AMR 감시 지표 균으로, 식품·임상 유래 균주의 내성·독성 평가가 풍부하다. (1) 한국 가공 돈육 제품 분리 *E. faecium*의 오염률·14종 항균제 내성·분자다양성 분석 ([[Jay's Knowledge Base/raw/229-kim-2020-occurrence-antimicrobial-resistance-and-molecular-d\|Kim 2020, *Foods*]]); (2) 발효 고추 분리 *E. faecium* B13의 유전체+표현형 기반 프로바이오틱성·안전성 종합 평가(병독성·내성 유전자 부재 확인 워크플로) — **균주 수준 안전성 입증 데이터 패키지의 모범 사례** ([[Jay's Knowledge Base/raw/230-xiao-2024-assessment-of-the-safety-and-probiotic-properties\|Xiao 2024, *Microorganisms*]]); (3) 157개 *E. faecium* 임상 분리주의 약제 내성 분석 ([[Jay's Knowledge Base/raw/231-jing-2007-drug-resistance-analysis-of-157-strains-of-enteroc\|Jing 2007]]); (4) 요양시설 내 반코마이신 내성 *E. faecium*/*E. faecalis*(VRE) 집락 역학 ([[Jay's Knowledge Base/raw/232-davis-2020-epidemiology-of-vancomycin-resistant-enterococcus\|Davis 2020, *Open Forum Infect. Dis.*]]); (5) *E. faecium*·*E. casseliflavus* 군에 광범위 분포·발현되는 ccrABEnt serine recombinase 유전자(이동성 유전요소·유전체 재배열 잠재) ([[Jay's Knowledge Base/raw/233-bjørkeng-2010-ccrabent-serine-recombinase-genes-are-widely-d\|Bjørkeng 2010, *Microbiology*]]); (6) *E. faecium*/*E. faecalis* 균혈증의 획득 경로·예후 ([[Jay's Knowledge Base/raw/234-noskin-1995-enterococcus-faecium-and-enterococcus-faecalis-b\|Noskin 1995, *Clin. Infect. Dis.*]]). 이들은 프로바이오틱/LBP 균주 선정 시 **획득 항생제 내성·전이성 유전요소·기회감염 리스크**를 평가하는 안전성 근거로 활용된다.
...
- **포스트바이오틱 보고·QC 표준화와 불활성화 조건 문서화 (Anjum & Ouwehand 2026)**: 살균(비활성) 제제는 LBP와 달리 생균수(CFU) 기반 역가 규격을 쓸 수 없어 **불활성화 공정 자체가 품질 속성**이 된다. 그러나 포스트바이오틱 임상연구 101편을 검토한 결과 **합의된 정의가 없고**, 열처리를 보고한 69편에서 온도 **70~140°C**, 시간 **4초~10시간**으로 조건이 극단적으로 산포되어 있음이 확인됨 → 「pasteurized」 표기만으로는 배치·제품 간 동등성(comparability)을 주장할 수 없다. 저자들이 제시한 보고 요건 4개항 — ① 출처 미생물의 **정확한 분류학적 동정**, ② 불활성화 방법의 **정확한 용어 + 상세 조건(온도·시간·매질)**, ③ **투여량(administered quantity)**, ④ **QC 정보** — 은 CTD 3.2.S(원료 특성화)·3.2.P(제조공정·규격) 문서화 요건과 직접 대응한다. 또한 **잔존 DNA에 전이성 항생제 내성 유전자(ARG)가 포함될 가능성**을 리스크로 명시해, EFSA QPS/AMR 평가가 생균에 한정되지 않고 **비활성 제제의 유전물질에도 적용**되어야 함을 시사(cf. 위 항생제 감수성·*Enterococcus* AMR 항목). 부수 리스크로 **산화·효소적 분해 감수성**(안정성 시험 설계)과 **잠재적 알레르기원성**(안전성 평가)이 지적됨 ([[Jay's Knowledge Base/raw/591-anjum-2026-postbiotics-an-overview-and-recommendations-for\|Anjum & Ouwehand 2026, *Mol. Nutr. Food Res.*]]; 균주 간 효능 편차는 [[Jay's Knowledge Base/wiki/akkermansia-strain-landscape\|akkermansia-strain-landscape]], 정량 QC는 [[Jay's Knowledge Base/wiki/bioprocess-engineering\|bioprocess-engineering]], 정의·범위는 [[Jay's Knowledge Base/wiki/probiotics-prebiotics-postbiotics\|probiotics-prebiotics-postbiotics]] 참조)
...
- [[Jay's Knowledge Base/raw/154-unknown-2015-bergeys-manual-of-systematics-of-archaea-and-ba\|raw/154-unknown-2015-bergeys-manual-of-systematics-of-archaea-and-ba]] — 세균·고세균 분류 표준 레퍼런스(균주 동정 근거)
...
- [[Jay's Knowledge Base/raw/166-ulger-toprak-2015-butyricimonas-virosa-the-first-clinical-ca\|raw/166-ulger-toprak-2015-butyricimonas-virosa-the-first-clinical-ca]] — *Butyricimonas virosa* 첫 균혈증 사례(NGP 후보 안전성 caveat)
- [[Jay's Knowledge Base/raw/214-dermoumi-2001-isolation-and-antimicrobial-susceptibility-tes\|raw/214-dermoumi-2001-isolation-and-antimicrobial-susceptibility-tes]] — 산소 불내성 장내 고세균 *M. smithii*의 분리·AMR 시험법
- [[Jay's Knowledge Base/raw/229-kim-2020-occurrence-antimicrobial-resistance-and-molecular-d\|raw/229-kim-2020-occurrence-antimicrobial-resistance-and-molecular-d]] — 한국 가공 돈육 *E. faecium*의 AMR·분자다양성
- [[Jay's Knowledge Base/raw/230-xiao-2024-assessment-of-the-safety-and-probiotic-properties\|raw/230-xiao-2024-assessment-of-the-safety-and-probiotic-properties]] — *E. faecium* B13 유전체+표현형 안전성·프로바이오틱성 평가
- [[Jay's Knowledge Base/raw/231-jing-2007-drug-resistance-analysis-of-157-strains-of-enteroc\|raw/231-jing-2007-drug-resistance-analysis-of-157-strains-of-enteroc]] — 157개 *E. faecium* 임상 분리주 약제 내성 분석
- [[Jay's Knowledge Base/raw/232-davis-2020-epidemiology-of-vancomycin-resistant-enterococcus\|raw/232-davis-2020-epidemiology-of-vancomycin-resistant-enterococcus]] — 요양시설 VRE(*E. faecium*/*faecalis*) 집락 역학
- [[Jay's Knowledge Base/raw/233-bjørkeng-2010-ccrabent-serine-recombinase-genes-are-widely-d\|raw/233-bjørkeng-2010-ccrabent-serine-recombinase-genes-are-widely-d]] — *E. faecium* 군의 ccrABEnt serine recombinase 분포·발현
- [[Jay's Knowledge Base/raw/234-noskin-1995-enterococcus-faecium-and-enterococcus-faecalis-b\|raw/234-noskin-1995-enterococcus-faecium-and-enterococcus-faecalis-b]] — *E. faecium*/*faecalis* 균혈증 획득 경로·예후
...
- [[Jay's Knowledge Base/raw/591-anjum-2026-postbiotics-an-overview-and-recommendations-for\|raw/591-anjum-2026-postbiotics-an-overview-and-recommendations-for]] — 포스트바이오틱 임상연구 101편 검토: 정의 부재, 불활성화 조건 편차(70~140°C·4초~10시간), 전이성 ARG 보유 DNA·알레르기원성·산화/효소 분해 리스크, 보고 표준화 4개 권고(분류·불활성화 조건·투여량·QC) (*Mol. Nutr. Food Res.* 2026)
